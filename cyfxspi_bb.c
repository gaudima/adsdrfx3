...
void CyFxGpioInit(void) {
	...
	apiRetStatus = CyU3PDeviceGpioOverride(ADSPI_EN, CyTrue);
	if (apiRetStatus != 0) {
		/* Error Handling */
		CyU3PDebugPrint(4,
				"SPI_SS0 CyU3PDeviceGpioOverride failed, error code = %d\n",
	...
	apiRetStatus = CyU3PGpioSetSimpleConfig(ADSPI_EN, &gpioConfig);
	if (apiRetStatus != CY_U3P_SUCCESS) {
		/* Error handling */
		CyU3PDebugPrint(4,
				"CyU3PGpioSetSimpleConfig failed, error code = %d\n",
	...
	//ADSPI_EN
	apiRetStatus = CyU3PGpioSetValue(ADSPI_EN, CyTrue);
	if (apiRetStatus != CY_U3P_SUCCESS) {
		/* Error handling */
		CyU3PDebugPrint(4,
				"CyU3PGpioSetValue failed, error code = %d\n",
